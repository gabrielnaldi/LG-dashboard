<div id="mobile-sidebar-container" class="fixed inset-0 z-50 hidden md:hidden">
    ...
    <div class="relative w-64 h-full bg-sidebar shadow-lg">
        <button id="close-mobile-sidebar" class="absolute top-2 right-2 h-6 w-6 flex items-center justify-center rounded-full bg-white text-black">
        ×
        </button>
